...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.m_embedder = LabelEmbedder(modes, hidden_size, class_dropout_prob)
    ...
    def initialize_weights(self):
        ...
        nn.init.normal_(self.m_embedder.embedding_table.weight, std=0.02)
    ...
    def forward(self, x, t, y, m=None):
        ...
        if m is not None:
            m = self.m_embedder(m, self.training)
            c = t + y + m
        else:
            c = t + y                           # (N, D)
        for block in self.blocks:
    ...
    def forward_with_cfg(self, x, t, y, cfg_scale, m=None):
        """
        ...
        model_out = self.forward(combined, t, y, m)
