...
try:
    ...
    _import_structure["scheduling_ddim_mode_guidance"] = ["DDIMModeScheduler"]
    ...
    _import_structure["scheduling_ddpm_mode_guidance"] = ["DDPMModeScheduler"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .scheduling_ddim_mode_guidance import DDIMModeScheduler
        from .scheduling_ddim_inverse import DDIMInverseScheduler
        from .scheduling_ddim_parallel import DDIMParallelScheduler
        from .scheduling_ddpm import DDPMScheduler
        from .scheduling_ddpm_mode_guidance import DDPMModeScheduler
