...
try:
    ...
    _import_structure["pipeline_stable_diffusion_mode_guidance"] = ["StableDiffusionModeGuidancePipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_mode_guidance import StableDiffusionModeGuidancePipeline
